...
function App() {
  ...
  const fingerDetected = latest?.finger ?? false;
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* 🚀 PERBAIKAN STRUKTUR INDUK: Menggunakan Flex vertikal penuh */
        .root { 
          min-height: 100vh; 
          width: 100%;
          background: #111; 
        ...
        .overview-header { display: flex; align-items: baseline; justify-content: space-between; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 10px; }
